                                    ...
                                    <table class="mb-0 table table-sm table-borderless">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{implode(',', json_decode($order->name)) }} </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Address:</th>
                                                <td>{{ json_decode($order->shipping_address)->city }},{{ json_decode($order->shipping_address)->pincode }},{{ json_decode($order->shipping_address)->state }}
                                                </td>
                                            </tr>
                                            <tr>
                                                                ...
                                                                <tbody>
                                                                    @php $order_detail=$order; @endphp
                                                                        <tr>
                                                                            ...
                                                                            @endif
                                                                            <td>
                                                                             Puja Date : {{date('Y-m-d H:i:s', $order_detail->date)}}<br>
                                                                            </td>
