                    ...
                    <div class="col-lg-6 mx-auto booking-form-column">
                        <div class="inner-column wow fadeInRight animated animated" data-wow-delay="200ms">
                            ...
                            <div class="main-contact-area">
                                ...
                                <form action="{{ route('pujari.login') }}" class="login_form bk-form" name="sms_form"
                                            ...
                                            <div class="single-form mt-3">
                                                ...
                                                <p class="mt-2 text-center"
                                                    ...
                                                    <span id="sms_otp_number"></span><span><a href="#"
                                                            onclick="sms_edit_number()"> (Edit) </a></span></p>
                                ...
                                <form action="{{ route('pujari.login') }}" class="login_form bk-form" name="sms_form"
                                    ...
                                    <div class="form-group floating-label">
                                        <div id="sms_otp" style="display:none;" class="otp_send">
                                            <div class="single-form mt-3">
                                                ...
                                                <p class="mt-2 text-center"
                                                    style="width: 100%; font-style: italic; color: gray;">मोबाइल नंबर: <span
                                                        id="sms_otp_number"></span><span><a href="#"
                                                            onclick="sms_edit_number()"> (संपादित करें) </a></span></p>
                                                <div id="divOuter" class="m-auto">
                                                    <div id="divInner">
                                                        <input id="partitioned_sms" name="check_otp" type="text"
                                                            maxlength="4"
                                    ...
                                    <div id="sms_form_button_div">
                                        <div class="input-btn text-center form-submit">
                                            ...
                                            <a id="login_by_sms" class="btn btn-theme text-white btn-radius w-100"><i
                                                    class="far fa-mobile"></i> SMS OTP के साथ लॉगिन करें <i
                                                    class="fad fa-angle-right"></i></a>
        ...
        $("#login_by_sms").click(function() {
            ...
            if (phone.length == 10) {
                ...
                $.ajax({
                    ...
                    async: true,
                    dataType: 'json',
                    url: "{{ route('pujari.send_pujari_otp') }}",
                    data: {
                        _token: '{{ csrf_token() }}',
                        phone: phone,
                        form_name: 'sms_form'
                    ...
                    success: function(response) {
                        ...
                        if (response.status == true) {
                            ...
                            alert('Your Phone Number Is Not Verified');
                        }
