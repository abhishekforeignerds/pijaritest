            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">Vendor Report</h6>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var dataTable = $('#datatable').DataTable({
                ...
                'ajax': {
                    'url': '{{ route('admin_get_vendor_report') }}',
                    'data': function(data) {
                        // Read values
                ...
                'columns': [{
                    ...
                    },
                    {
                        mRender: function(data, type, row) {
                            return '<span> Name:'+row.name+'<br>Phone:'+row.phone+'<br>Vendor Code:'+row.vendor_code+'<br></span>';
                        }
                    },
                    {
                        data: 'firm_name'
                    ...
                    {
                        mRender: function(data, type, row) {
                            return '<span> Order Sale:'+row.order_sale+'<br>Pos Sale:'+row.pos_sale+'</span>';
                        }
                    },
                    {
                        data: 'status',
                    ...
                    {
                        mRender: function(data, type, row) {
                            return '<div class="d-flex order-actions"><a href="{{ route('admin.report.vendor_report_detail', '') }}/' +
