            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">Vendor Recharge Report</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table>
                        <tr>
                            <td>
                                <div class="mb-3">
                                    <select id='searchVendor' class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            var dataTable = $('#datatable').DataTable({
                ...
                'ajax': {
                    'url': '{{ route('admin_get_vendor_rechargeReport') }}',
                    'data': function(data) {
                        // Read values
                        var gender = $('#searchByGender').val();
                        var name = $('#searchByName').val();
                        var vendor = $('#searchVendor').val();
                        var paymentType = $('#searchType').val();
