                                    ...
                                    <div class="col-md-4 col-sm-5 mb-30">
                                        <div class="invoice-number">
                                            <div class="invoice-number-inner">
                                                ...
                                                <p class="invo-addr-1 mb-0">
                                                    {{ json_decode($order->shipping_address)->house_no }},{{ json_decode($order->shipping_address)->area }} -
                                ...
                                <div class="order-summary">
                                    <div class="">
                                        <table class="default-table invoice-table">
                                            ...
                                            <tr>
                                                <td colspan="3" style="text-align: right;"><strong>Wallet Dis.</strong></td>
                                                <td><strong>₹  {{$order->wallet_discount}}</strong></td>
                                            </tr>
                                            @endif

                                            <tr>
                                                <th colspan="3" style="text-align: right;">Dakshina :</th>
                                                <td>₹{{ $order->dakshina?:0 }}</td>
                                            </tr>

                                            <tr>
                                                <th colspan="3" style="text-align: right;">Prashad :</th>
                                                <td>₹{{ $order->prashad_price?:0 }}</td>
                                            </tr>
