            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">{{ !empty($category->id) ? 'View' : 'Add' }} Service Category</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <img id="frame" src="{{$category->full_image_url}}" style="{{ !empty($category->icon) ? 'display:block' : 'display:none' }}" width="100px" height="100px"/>
                        </div>
