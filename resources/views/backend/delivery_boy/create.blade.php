            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">Add Delivery Boy</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-body">
                        <form class="row g-4" method="post" action="{{route('delivery-boy.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" id="aadhaar_front"
                                    placeholder="Select Image" name="aadhaar_front">
                                    <img class="mt-2" id="img" src=""
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" id="aadhaar_back"
                                    placeholder="Select Image" name="aadhaar_back">
                                    <img class="mt-2" id="img2" src=""
                                    onerror="this.onerror=null;this.src='{{ asset('backend/images/no-image.jpg') }}'"
                                    height="80px" width="80px">
                                    @error('aadhaar_back')
                                        <span class="text-danger">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" id="pan"
                                    placeholder="Select Image" name="pan">
                                    <img class="mt-2" id="img3" src=""
                                    onerror="this.onerror=null;this.src='{{ asset('backend/images/no-image.jpg') }}'"
                                    height="80px" width="80px">
                                    @error('pan')
                                        <span class="text-danger">
                            ...
                            <div class="col-md-6">
                                <label for="bank_name" class="form-label">Bank Name</label>
                                    <input type="text" class="form-control" value="{{old('bank_name')}}" id="bank_name" name="bank_name"
                            ...
                            <div class="col-md-6">
                                <label for="bank_account_no" class="form-label">Bank Account No.</label>
                                    <input type="text" class="form-control" value="{{old('bank_account_no')}}" id="bank_account_no" name="bank_account_no"
                            ...
                            <div class="col-md-6">
                                <label for="ifsc_code" class="form-label">IFSC Code</label>
                                    <input type="text" class="form-control" value="{{old('ifsc_code')}}" id="ifsc_code" name="ifsc_code"
