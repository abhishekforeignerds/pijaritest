    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="card radius-10">
                ...
                <div class="card-body">
                    <table>
                        <form method="GET" id="order_form" action="{{ route('customer_order',$id) }}">
                            <tr>
                                <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex order-actions">
                                            ...
                                            <a href="{{route('admin.order_show',$order->id)}}" class="" title="Show"><i class="bx bxs-show"></i></a>
                                            <a href="{{route('order.payment_transaction',$order->id)}}" class="" title="Transaction"><i class="fa fa-wallet"></i></a>
                                        </div>
                                        @endif
                                    </td>
                                </tr>
