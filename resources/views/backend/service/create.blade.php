                ...
                <form method="POST" action="{{ route('admin_service.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto"><button type="submit" class="btn btn-primary radius-30 mt-2 mt-lg-0">Save</button></div>
                        </div>
                    </div>
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select" aria-label="Vendor" id="vendor_id" name="vendor_id" onchange="get_category()" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" aria-label="Service Category" name="category_id" id="category_id" onchange="get_subcategory()" required>
