...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="card">
                <form method="POST" action="{{ route('admin_service.update', $service->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-body row mt-4">
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="inputserviceTitle" class="form-label">Service Name<span>*</span></label>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="file" class="form-control" name="thumbnail" accept="image/*"
                                                id="thumbnail" placeholder="Enter service title" required>
                                        </div>
                                        <div class="col-md-12 mb-3">
                            ...
                            <div class="col-lg-6">
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label for="Vendor" class="form-label">Vendor<span>*</span></label>
                                            <select class="form-select" aria-label="Vendor" id="vendor_id" name="vendor_id"
                                                onchange="get_category()" required>
                                                <option>Select Vendor</option>
                                                @foreach (App\Models\Vendor::all() as $vendor)
                                                    <option value="{{ $vendor->id }}"
                                                        @if ($service->vendor_id == $vendor->id) {{ 'Selected' }} @endif>
                                                        {{ $vendor->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="Category" class="form-label">Service Category<span>*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="SubCategory" class="form-label">Service SubCategory<span>*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="dPrice" class="form-label">Disconted Price</label>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="tag" id="inputserviceTags"
                                                placeholder="Enter service Tags" value="{{ $service->tag }}">
                                        </div>
                                        <div class="col-md-12">
...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.documentDropzone = {
            url: '{{ route('admin_projects.storeMedia_service') }}',
            maxFilesize: 2, // MB
            addRemoveLinks: true,
            headers: {
