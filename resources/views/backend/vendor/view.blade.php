                    ...
                    <div class="form-body row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form-select" id="multiple-select-clear-field"
                                    data-placeholder="Choose anything" onchange="comission_table_show()" disabled multiple>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" id="vendor_regiter_fees" name="vendor_regiter_fees" method="post"
                        action="{{ route('admin.pay_registration_fee',$vendor->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="productPaymentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" id="vendor_categories_fess" name="vendor_categories_fess" method="post" action="{{route('admin.pay_vendor_categories_product_fess',$vendor->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="servicePaymentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" id="vendor_categories_fess" name="vendor_categories_fess" method="post" action="{{route('admin.pay_vendor_categories_service_fess',$vendor->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
