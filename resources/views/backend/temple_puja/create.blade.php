...
<div class="page-wrapper">
    <div class="page-content">
        <div class="card">
            <form method="POST" action="{{ route('temple_puja.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="top_search justify-content-start">
                                ...
                                <a href="{{ route('temple_puja.index') }}" class="btn btn-link">
                                    <i class="fa fa-arrow-left"></i>
                                </a>
                                <h6 class="card_title">Add New Temple Puja</h6>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="short_description_hindi"
                                            name="short_description_hindi"></textarea>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="city" class="form-label">City<span>*</span></label>
                                        <select class="form-select select2" aria-label="City" name="city[]" id="city"
                                            onchange="getPincode()" multiple>
