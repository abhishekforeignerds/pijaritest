...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="card">
                <form method="POST" action="{{ route('temple_puja.update', $product->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select select2" aria-label="City" name="city[]"
                                                ...
                                                @foreach (App\Models\TerthPujaCity::all() as $city)
                                                    <option value="{{ $city->id }}"
                                                        @if (in_array($city->id, json_decode($product->city))) selected @endif>
                                                        {{ $city->city }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="inputProductDescription" class="form-label">Key Insights</label>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="inputProductDescription" class="form-label">FAQ</label>
                            <textarea id="faq" name="faq">{{ $product->faq }}
                            </textarea>
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="inputProductDescription" class="form-label">FAQ (Hindi)</label>
                            <textarea id="faq_hindi" name="faq_hindi">{{ $product->faq_hindi }}
                            </textarea>
                        </div>
