...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            @if(count(json_decode(Auth::guard('vendor')->user()->business_category)) == 0)
              <marquee width="100%" direction="left" height="100px">
                Your registration is successfull,your account will be verified within 24hrs.After verification you can pay registion fees from profile.
              </marquee>
            @endif
            @if(count(json_decode(Auth::guard('vendor')->user()->business_category)) > 0 && Auth::guard('vendor')->user()->status==0)
              <marquee width="100%" direction="left" height="100px">
                Pay registration fees from profile to activate your account.
              </marquee>
            @endif
                    ...
                    <div class="card radius-10 border-start border-0 border-4 border-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Sell</p>
                ...
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-4 border-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Deposite</p>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Iphone 5</td>
                                    <td><img src="{{ asset('backend/images/products/01.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#9405822</td>
                                ...
                                <tr>
                                    <td>Earphone GL</td>
                                    <td><img src="{{ asset('backend/images/products/02.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#8304620</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('backend/images/products/03.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#4736890</td>
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="{{ asset('backend/images/products/04.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#8543765</td>
                                    <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span></td>
                                    <td>₹1200.00</td>
                                ...
                                <tr>
                                    <td>Sitting Chair</td>
                                    <td><img src="{{ asset('backend/images/products/06.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#9629240</td>
                                    <td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span>
                                    </td>
                                ...
                                <tr>
                                    <td>Hand Watch</td>
                                    <td><img src="{{ asset('backend/images/products/05.png') }}" class="product-img-2"
                                            alt="product img"></td>
                                    <td>#8506790</td>
