                ...
                <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto"><button type="submit" onclick="return confirm('Are you sure?')"
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="text_editors" name="description">
                                            </textarea>
                                        </div><br><br>
                                    </div>
                                </div>
                            ...
                            <div class="field_wrapper">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" id="s_w" name="s_w[]" class="form-control"
                                            placeholder="Enter Size/Weight" required>
                                        <span class="form-text">eg : 1L,1KG,L,M,S,32,34</span>
                                    </div>
                                    <div class="col-lg-2">
                                        <label class="form-label">MRP (₹) <span class="text-danger">*</span></label>
                                        <input type="text" placeholder="" data-a-sign="₹ " id="mrp" name="mrp[]"
                                            class="form-control autonumber" required>

                                    </div>
                                    <div class="col-lg-2">
                                        <label class="form-label">Sell Price (₹) <span class="text-danger">*</span></label>
                                        <input type="text" placeholder="" data-a-sign="₹ " id="sell_price"
                                            name="sell_price[]" class="form-control autonumber" required>
                                    ...
                                    <div class="col-lg-1 mb-2">
                                        <label for="fileInput" class="uploadButton">
                                            <img class="imagePreview" id="imagePreview_fileInput"
                                                src="https://seller.grocito.com/d.png" alt="Placeholder">
                                        </label>
                                        <input type="file" class="file_input" id="fileInput" name="thumbnail[]"
                                            onchange="file_add_new('fileInput')" accept="image/*" required>
                                    </div>
                                    <div class="col-lg-1">
                                        <a class="add_button btn btn-primary" style="margin-top: 32px;float: right;"
                                            title="Add Variant">+</a>
                                    </div>
                                </div>
