      ...
      <div class="topbar d-flex align-items-center">
          <nav class="navbar navbar-expand gap-3">
              ...
              <div class="user-box dropdown px-3">
                  <a class="d-flex align-items-center nav-link dropdown-toggle gap-2 dropdown-toggle-nocaret show"
                      href="#" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                      <div class="user-info">
                          <p class="user-name mb-0"> {{ Auth::guard('pujari')->user()->name }}</p>
                      </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                          <a class="dropdown-item d-flex align-items-center" href="{{ route('pujari.logout') }}">
