...
class TemplePujaController extends Controller
{
    /**
    ...
    {
        return view('backend.temple_puja.index');
    }
    ...
    public function get_product(Request $request)
    {
        ...
        $totalFilter = Product::where('id','>',0)->where('product_type','temple');
        ...
        $arrData = Product::where('id','>',0)->where('product_type','temple')->with(['category']);
    ...
    {
        return view('backend.temple_puja.create');
    }

    public function package_add($id){
        $product=Product::find($id);
        return view('backend.temple_puja.package_add',compact('product'));
    }

    public function product_package($id){
        $list=Package::where('product_id',$id)->get();
        return view('backend.temple_puja.view_package',compact('list','id'));
    }

    public function product_package_edit($id){
        $data=Package::find($id);
        $product=Product::find($data->product_id);
        return view('backend.temple_puja.package_edit',compact('data','product'));
    }
    ...
    public function package_update(Request $request){
        ...
        return redirect()->route('temple_puja.index');
    ...
    public function product_package_update(Request $request){
        ...
        return redirect()->route('temple_puja_package',$package->product_id);
    ...
    public function edit($id)
    {
        ...
        $product=Product::find($id);
        return view('backend.temple_puja.edit', compact('product'));
    }
    public function view($id)
    {
        // return $product->getMedia('photos');
        $product=Product::find($id);
        return view('backend.temple_puja.view_package', compact('product'));
    }
    /**
    ...
    public function product_package_delete($id){
        ...
        return redirect()->route('temple_puja_package',$product_id);
    }
}
